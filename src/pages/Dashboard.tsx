    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-600 mt-1">
          Catalog overview and health metrics
        </p>
      </div>
            ...
            <div className="pt-4 border-t space-y-3">
              <div>
                ...
                <div className="w-full bg-gray-200 rounded-full h-2">
                  <div
                    className={`h-2 rounded-full ${basicInfoScore >= 80 ? "bg-green-500" : basicInfoScore >= 60 ? "bg-yellow-500" : "bg-orange-500"}`}
                    style={{ width: `${basicInfoScore}%` }}
                  ></div>
                </div>
              </div>
              <div>
                ...
                <div className="w-full bg-gray-200 rounded-full h-2">
                  <div
                    className={`h-2 rounded-full ${attributesScore >= 80 ? "bg-green-500" : attributesScore >= 60 ? "bg-yellow-500" : "bg-orange-500"}`}
                    style={{ width: `${attributesScore}%` }}
                  ></div>
                </div>
              </div>
              <div>
                ...
                <div className="w-full bg-gray-200 rounded-full h-2">
                  <div
                    className={`h-2 rounded-full ${imagesScore >= 80 ? "bg-green-500" : imagesScore >= 60 ? "bg-yellow-500" : "bg-orange-500"}`}
                    style={{ width: `${imagesScore}%` }}
                  ></div>
                </div>
              </div>
            </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-7 gap-4">
          {quickActions.map((action) => {
            ...
            return (
              ...
              >
                <div
                  className={`p-3 rounded-lg bg-${action.color}-50 group-hover:bg-${action.color}-100 transition-colors`}
                >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="bg-white rounded-lg shadow">
          <div className="p-6 border-b">
            ...
            <p className="text-sm text-gray-600 mt-1">
              Data quality metrics per brand
            </p>
          </div>
          <div className="p-6">
            <DataCompletenessChart
              data={brandCompleteness}
        ...
        <div className="bg-white rounded-lg shadow">
          <div className="p-6 border-b">
            ...
            <p className="text-sm text-gray-600 mt-1">
              Data quality metrics per industry
            </p>
          </div>
          <div className="p-6">
            <DataCompletenessChart
              data={industryCompleteness}
              title="Industry Completeness"
            />
          </div>
        </div>
